import foto from "../assets/unsplash_75EFpyXu3WgPosts.jpg";

export const Post = () => {
  return (
    <>
      <article className="basis-[40%] shadow-lg">
        <div className="flex justify-center gap-4 max-sm:flex-wrap ">
          <div className="relative basis-[35%] max-sm:basis-[80%] aspect-[2/3.5] max-sm:aspect-[1/1]">
          ...
          <div className="flex flex-col basis-[55%] max-sm:basis-[80%] aspect-[1/1] max-sm:aspect-[1/1] justify-evenly">
            <div className="flex justify-between">
              ...
              <div className="flex bg-black gap-1 rounded-3xl py-2 px-3">
                <i class="fa-solid fa-star text-yellow text-xs max-sm:text-base"></i>
            ...
            <div className="flex gap-1">
              <i class="fa-solid fa-arrow-up-from-bracket text-sm text-secondTextColor"></i>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-1 text-xs max-sm:text-lg">
                <i class="fa-regular fa-chart-bar text-alert"></i>
